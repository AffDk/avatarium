...
- Python 3.12+ (subject of documentation, not implementation) + Markdown, Mermaid diagram syntax (documentation tooling only) (004-code-walkthrough-docs)
- N/A — documentation files only, stored in `specs/004-code-walkthrough-docs/` (004-code-walkthrough-docs)
...
## Recent Changes
- 004-code-walkthrough-docs: Added Python 3.12+ (subject of documentation, not implementation) + Markdown, Mermaid diagram syntax (documentation tooling only)
